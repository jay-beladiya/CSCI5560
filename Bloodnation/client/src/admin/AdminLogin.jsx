...
function AdminLogin() {
  ...
  return (
    <>
      ...
      <div className=' flex justify-center items-center h-1/2 w-1/3 bg-blend-darken sidebar-bg rounded-2xl backdrop-saturate-150 backdrop-blur-md shadow-lg'>
          ...
          <button type='submit' className='w-30 h-10 self-center rounded-2xl bg-white font-bold hover:shadow-xl hover:cursor-pointer'>Login</button>
                </form>
            </div>
        </section>
    </>
