...
function Home() {   
  ...
  return (
    <>
        {navComponent}
  <section className=' h-[89vh] flex justify-center items-center bg-app'>
        ...
        <div className=' flex justify-center items-center mt-10 w-24 h-14 shadow-lg btn-primary btn-animate rounded-2xl hover:cursor-pointer'><Link to="/about" className='text-on-primary'>About Us</Link></div>
            </div>
        </section>
    </>
  )
