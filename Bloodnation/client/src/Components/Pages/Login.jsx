...
function Login() {
  ...
  <div className=" flex justify-center items-center h-1/2 w-1/3 bg-app backdrop-saturate-150 backdrop-blur-md shadow-lg">
          ...
          >
            ...
            />
            {emailErr && <p className=" text-primary text-xs">{emailErr}</p>}
            <input
            ...
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium hover:text-secondary hover:underline">
                <Link>Forgot Password?</Link>
              </span>
            </div>
            <button
              type="submit"
              className="w-30 h-10 self-center rounded-2xl btn-primary btn-animate"
            >
              Login
            </button>
